...
class SpUtil<T>(val name: String, private val default: T) {
    ...
    companion object {
        private const val file_name = "sp_kotlin_mvp_file"
    ...
    private fun putSp(name: String, value: T) = with(prefs.edit()) {
        when (value) {
    ...
    private fun getSp(name: String, default: T): T = with(prefs) {
